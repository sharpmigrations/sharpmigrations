...
namespace SharpMigrations {
    public abstract class ReversibleSchemaMigration : Migration {
        ...
        public IFluentRename Rename => _schemaMigrationRename ?? (_schemaMigrationRename = new FluentRename(DataClient));
        ...
        protected class Column {
            ...
            public static FluentColumn Clob(string name) {
                return SharpData.Schema.Column.Clob(name);
            }
        ...
        public sealed override void Down() {
            ...
            var downActions = _reversibleActions.Select(x => {
